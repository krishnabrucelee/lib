...
/**
 * @author Assistanz Servlet implementation class DeleteMemberController
 */
@WebServlet(name = "DeleteMemberController", displayName = "Delete Member Controller", urlPatterns = {
        "/deleteMember" })
public class DeleteMemberController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            ...
            request.setAttribute("alert", memberServ.deleteMember(member));
